...
public class ABMSimulator2 extends JFrame {
    ...
    private static HashMap<String, Object> pubMemory = new HashMap<>();
    private ArrayList<String> pubAddressMemory = new ArrayList<>();
    private HashMap<String, String> pubAddressMemoryTemp = new HashMap<>();
        ...
        public void runCommands() {
            ...
            while (true) {
                ...
                if (instruction.equals(":=")) {
                    ...
                    if (pubAddressMemoryTemp.containsKey(key)) {
                        hmap.put(pubAddressMemoryTemp.get(key), value);
                    } else {
                ...
                if (instruction.equals("+")) {
                    int v2 = Integer.parseInt(stackstorage.pop());
                    String v1 = (stackstorage.pop());

                    for (int i = 0; i < pubAddressMemory.size(); i++) {
                        if (pubAddressMemory.get(i).equals(v1)) {
                            String addr = pubAddressMemory.get(i + v2);

                            stackstorage.push(addr);
                        }
                    }
                }
                if (instruction.equals("-")) {
                ...
                // Version 2
                // if this value is true then following variables stored in public memory
                ...
                if (instruction.equals(":&")) {
                    String key1 = stackstorage.pop();
                    String key2 = stackstorage.pop();

                    pubAddressMemoryTemp.put(key2, key1);
                }
                ...
                if (instruction.startsWith(".int")) {
                    ...
                    for (String item : contents) {
                        ...
                        pubAddressMemory.add(item.trim());
                    }
                }
